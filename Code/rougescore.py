...
peer = machine summary, model = human summary
"""
...
def rouge_vec(peer, models):
    p1 = rouge_1(peer, models, 1)
    r1 = rouge_1(peer, models, 0)
    f1 = rouge_1(peer, models, 0.5)
    p2 = rouge_2(peer, models, 1)
    r2 = rouge_2(peer, models, 0)
    f2 = rouge_2(peer, models, 0.5)
    pl = rouge_l(peer, models, 1)
    rl = rouge_l(peer, models, 0)
